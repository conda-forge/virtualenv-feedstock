...
pixi global install virtualenv
```
...
It is possible to list all of the versions of `virtualenv` available on your platform:
...
```
pixi search virtualenv --channel conda-forge
```
